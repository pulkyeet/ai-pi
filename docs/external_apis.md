...
| Reddit | **DROPPED (per D5)** | n/a | n/a | n/a | Initially planned as a Tier-2 source; **skipped because self-service registration is closed and the manual 2–4 wk app-approval process was infeasible** — no Reddit integration ships. HN Algolia + GitHub + Stack Exchange are the community-mining backbone regardless — see [README](execution_phases/README.md#deviations-from-the-masterplan). |
...
| Reddit | ⏸ Dropped (D5) | — | Initially planned as a Tier-2 source; **skipped because the manual 2–4 wk app-approval process was infeasible**. No integration ships. Community mining runs on HN Algolia + GitHub + Stack Exchange (D5). |
